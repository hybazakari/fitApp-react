...
import { COLORS, SPACING, BORDER_RADIUS, TYPOGRAPHY, SHADOWS, COMMON_STYLES } from '../../constants/theme';
    ...
    <View style={styles.stepContainer}>
      ...
      <View style={styles.featuresList}>
        <View style={styles.featureItem}>
          <Ionicons name="nutrition-outline" size={24} color={COLORS.primary} style={styles.featureIcon} />
          <Text style={styles.featureText}>Track your daily nutrition with precision</Text>
        </View>
        
        <View style={styles.featureItem}>
          <Ionicons name="barbell-outline" size={24} color={COLORS.primary} style={styles.featureIcon} />
          <Text style={styles.featureText}>Build personalized workout programs</Text>
        </View>
        
        <View style={styles.featureItem}>
          <Ionicons name="stats-chart-outline" size={24} color={COLORS.primary} style={styles.featureIcon} />
          <Text style={styles.featureText}>Monitor your progress with detailed charts</Text>
        </View>
        
        <View style={styles.featureItem}>
          <Ionicons name="trophy-outline" size={24} color={COLORS.primary} style={styles.featureIcon} />
      ...
      <View style={styles.optionsRow}>
        ...
        >
          <Ionicons 
            name="male-outline" 
            size={24} 
            color={profileData.gender === 'male' ? COLORS.textWhite : COLORS.textSecondary} 
        ...
        >
          <Ionicons 
            name="female-outline" 
            size={24} 
            color={profileData.gender === 'female' ? COLORS.textWhite : COLORS.textSecondary} 
            style={{ marginBottom: SPACING.xs }}
          />
    ...
    <ScrollView style={styles.stepContainer} showsVerticalScrollIndicator={false}>
      ...
      >
        <View style={styles.goalIconContainer}>
          <Ionicons name="flame-outline" size={32} color={profileData.goal === 'weightLoss' ? COLORS.primary : COLORS.textSecondary} />
        </View>
      ...
      >
        <View style={styles.goalIconContainer}>
          <Ionicons name="scale-outline" size={32} color={profileData.goal === 'maintenance' ? COLORS.primary : COLORS.textSecondary} />
        </View>
        <View style={styles.goalContent}>
      ...
      >
        <View style={styles.goalIconContainer}>
          <Ionicons name="barbell-outline" size={32} color={profileData.goal === 'muscleGain' ? COLORS.primary : COLORS.textSecondary} />
        </View>
        <View style={styles.goalContent}>
      ...
      <View style={styles.optionsRow}>
        ...
        >
          <Ionicons 
            ...
            size={24} 
            color={profileData.trainingLocation === 'gym' ? COLORS.textWhite : COLORS.textSecondary} 
            style={{ marginBottom: SPACING.xs }}
          />
        ...
        >
          <Ionicons 
            name="home-outline" 
            size={24} 
            color={profileData.trainingLocation === 'home' ? COLORS.textWhite : COLORS.textSecondary} 
            style={{ marginBottom: SPACING.xs }}
          />
